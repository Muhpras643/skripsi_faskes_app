...
<body>
    <div class="header">
        ...
        <p>Halaman Hasil Klasifikasi (Admin)</p>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($specific_recommendations_exist) {
                                    ...
                                    // Jika tidak ada rekomendasi spesifik yang terfilter, tampilkan pesan umum berdasarkan prioritas
                                    if (empty($general_messages)) { // Hanya tampilkan ini jika tidak ada pesan umum sama sekali
                                        if ($faskes['prioritas_wilayah'] == 'Rendah') {
                                            echo "Unit kerja ini menunjukkan kondisi yang baik dan tidak teridentifikasi adanya kebutuhan penambahan tenaga medis atau penanganan penyakit yang mendesak berdasarkan kriteria yang ada. Disarankan untuk mempertahankan standar pelayanan yang sudah baik dan melanjutkan program preventif kesehatan.";
                                        } elseif ($faskes['prioritas_wilayah'] == 'Sedang') {
                                            echo "Prioritas 'Sedang' mengindikasikan bahwa unit kerja ini memerlukan pemantauan berkelanjutan. Meskipun belum ada kebutuhan spesifik yang mendesak, disarankan untuk melakukan evaluasi rutin terhadap beban penyakit dan ketersediaan tenaga medis agar alokasi sumber daya tetap efisien dan responsif terhadap perubahan kondisi.";
                                        } else { // Prioritas Tinggi, tapi tidak ada rekomendasi spesifik yang terstruktur
                                            echo "Unit kerja ini memiliki prioritas 'Tinggi', yang berarti ada urgensi signifikan. Namun, sistem belum dapat mengidentifikasi rekomendasi penambahan tenaga medis atau penanganan penyakit secara spesifik berdasarkan data yang tersedia. Diperlukan analisis manual lebih lanjut oleh Dinas Kesehatan untuk menentukan langkah intervensi yang paling tepat dan mendesak.";
                                        }
                                    }
                                }
                                ?>
